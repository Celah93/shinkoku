...
所得税計算・控除集計・ふるさと納税の上限推定は2025・2026年分に対応する。消費税は本則・簡易・2割特例が2025・2026年分、国内個人の3割特例が2027・2028年分。3割特例は計算・年度プロファイル保存までで、相続の例外・中間納付は未対応、画面入力は未検証。以下のペルソナ表を年分制限のない対応表として扱わない。
