...
所得税計算・控除集計は2025〜2027年分、ふるさと納税の上限推定は2025・2026年分に対応する。消費税は本則・簡易・2割特例が2025・2026年分、国内個人の3割特例が2027・2028年分。3割特例は相続の例外判定・国税地方税の中間納付精算・年度プロファイル保存まで対応し、画面入力は未検証。2027年の年金・給与調整、追加税と高所得特例などの対象外範囲は `docs/income-tax-2027.md` を参照する。以下のペルソナ表を年分制限のない対応表として扱わない。
