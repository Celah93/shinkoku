...
- `shinkoku ledger fiscal-year-show --db-path /home/user/tax-2025/shinkoku.db --fiscal-year 2025`
- 最終計算: `shinkoku tax calc-consumption --db-path /home/user/tax-2025/shinkoku.db --input /home/user/tax-2025/output/consumption_input.json`
