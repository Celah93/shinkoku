...
| 科目 | 内容 | 注意点 |
|------|------|--------|
| 消耗品費 / 減価償却費 | PC、モニター、キーボード等 | 青色特例はR8.3.31までの取得30万円未満、R8.4.1以後40万円未満 |
...
取得価額はR8.3.31までの取得なら30万円未満、R8.4.1以後なら40万円未満を一括経費算入可能
（租税特別措置法第28条の2）。
年間合計300万円まで。
...
| 科目 | 内容 | 注意点 |
|------|------|--------|
| 消耗品費 / 減価償却費 | カメラ、マイク、照明、PC | 青色特例は取得日基準で30万円未満または40万円未満 |
