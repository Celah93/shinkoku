...
以下の項目は令和8年度改正法・政令まで成立している。
詳細は [2026.md](./2026.md) を参照。

| 項目 | R8大綱での決定内容 |
|------|------------------|
| インボイス2割特例の終了 | R8.9で終了、R9-R10は3割特例（個人事業主のみ）に移行 |
| 免税事業者仕入控除の段階縮減 | R8.9.30まで80%、R8.10.1〜R10.9.30は70%、R10.10.1〜R12.9.30は50%、R12.10.1〜R13.9.30は30%、R13.10.1以降は0% |
| 復興特別所得税の見直し | R9〜税率1.1%に引下げ＋防衛特別所得税1%新設（合計2.1%変わらず） |
| 少額減価償却資産特例 | R8.4.1取得から40万円未満・従業員400人以下、R11.3.31まで延長 |
...
5. **少額減価償却資産特例の取得日境界を維持**（R8.3.31まで30万円、R8.4.1から40万円）
...
- **R8年分対応**: 基礎控除（本則62万円）、給与所得控除（最低69万円）、少額減価償却資産（取得日で30万円/40万円）の計算ロジック更新
