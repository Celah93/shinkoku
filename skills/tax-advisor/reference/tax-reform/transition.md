...
| 令和8年10月1日〜令和10年9月30日 | **70%** | 次期 |
| 令和10年10月1日〜令和12年9月30日 | **50%** | |
| 令和12年10月1日〜令和13年9月30日 | **30%** | |
| 令和13年10月1日〜 | **0%**（控除不可） | 完全移行 |

**R8大綱により当初の3段階から5段階に細分化。完全移行時期はR13.10。**
...
| 条件 | 借入限度額 | 控除期間 | 現行ツール |
|------|----------:|---------:|--------------|
| 50㎡以上、令和5年12月31日までに建築確認 | 2,000万円 | 10年 | 対応 |
| 50㎡以上、令和6年6月30日までに建築 | 2,000万円 | 10年 | 建築日入力がなく未対応 |
| 40㎡以上50㎡未満、令和5年末までに建築確認 | 2,000万円 | 10年 | 床面積判定が未対応 |

建築確認フラグが`false`なら原則対象外の0円を返すが、建築日経路を見落とさないよう
必ず警告も返す。警告が出たら建築日と床面積の証拠を確認する。
...
令和8年入居も「特例対象個人」として上乗せが続くが、金額は令和8年表を使う。
判定日は入居年の12月31日。
...
| 項目 | 内容 |
|------|------|
| 取得期限 | **令和11年3月31日**まで（令和8年法律第12号で確定） |
| 2026年3月31日までの取得 | **30万円未満**・従業員500人以下 |
| 2026年4月1日以後の取得 | **40万円未満**・従業員400人以下 |
| 年間上限 | 供用年ごとに300万円。開廃業年は業務月数で月割り |

新旧基準は年分ではなく取得日で分ける。根拠は措法28条の2、令和8年法律第12号7条・附則35条、
令和8年政令第98号附則9条であり、大綱段階ではない。
...
| R8.10〜R10.9 | 50% | **70%**（緩和） |
| R10.10〜R11.9 | 50% | **50%** |
| R11.10〜R12.9 | 0% | **50%**（延長） |
| R12.10〜R13.9 | 0% | **30%**（新設） |
| R13.10〜 | 0% | 0%（完全移行） |
...
- R8年10月〜R10年9月の2年間は70%控除（旧スケジュールの50%から緩和）
- R12年10月〜R13年9月は30%控除
...
├── 少額減価償却資産特例: R8.3.31取得まで30万円、R8.4.1取得から40万円
...
└── 免税事業者仕入控除: R12.9まで50%、R12.10〜30%

令和13年 (2031年)
├── 免税事業者仕入控除: R13.9まで30%、R13.10〜0%（完全移行）
└── 復興特別所得税1.1% + 防衛特別所得税1%: 継続
