...
所得税計算・控除集計は2025〜2027年分、ふるさと納税の上限推定は2025・2026年分に対応します。消費税は本則・簡易・2割特例が2025・2026年分、国内の個人事業者の3割特例が2027・2028年分に対応します。3割特例の相続の例外判定と、国税・地方税の中間納付精算にも対応します。2027年の新制度を含む作成コーナー入力は未検証です。[2027年分の計算と残る範囲](docs/income-tax-2027.md)を参照してください。機能ごとの年分は[対応範囲](docs/tax-year-support.md)を確認してください。
