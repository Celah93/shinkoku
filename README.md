...
所得税計算・控除集計・ふるさと納税の上限推定は2025・2026年分に対応します。消費税は本則・簡易・2割特例が2025・2026年分、国内の個人事業者の3割特例が2027・2028年分に対応します。3割特例は計算・年度プロファイル保存までで、相続に係る例外・中間納付があるケース・作成コーナーへの入力は未対応又は未検証です。機能ごとの年分は[対応範囲](docs/tax-year-support.md)を確認してください。
